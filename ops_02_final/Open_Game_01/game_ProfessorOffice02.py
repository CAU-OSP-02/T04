    ...
    def check_click(self):
        ...
        if self.top_rect.collidepoint(mouse_pos):
            ...
            if pygame.mouse.get_pressed()[0]:
                ...
                self.dynamic_elecation = self.elevation
                if self.pressed is True:
                    from Pause import pause_clearpro
                    pause_clearpro()
                    self.pressed = False
        else:
            self.dynamic_elecation = self.elevation
...
button5 = Button_clear('4, 3, 2, 1 / 짝수-홀수', 300, 40, (90, 475), 5)
button6 = Button_fail('4, 2, 3, 1 / 홀수-짝수', 300, 40, (400, 475), 5)
button7 = Button_fail('5, 6, 7, 8 / 짝수-홀수', 300, 40, (90, 525), 5)
button8 = Button_fail('5, 7, 6, 8 / 홀수-짝수', 300, 40, (400, 525), 5)
